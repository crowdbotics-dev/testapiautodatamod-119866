...
## Project Structure
    ...
    ├── testapiautodatamod_119866  # Django project configurations
...
1. Clone this repo and `cd testapiautodatamod_119866`
...
2. Clone this repo and `cd testapiautodatamod_119866`
